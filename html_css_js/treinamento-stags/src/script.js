loadPokemons().then(loadEvolutions).then(() => {
    var items = document.getElementsByClassName("evolutions__item")
    ...
    items.forEach((element, index )=> {
        ...
        children[1].src= pokemons[index].sprites.front_default
        children[2].src= pokemons[index].sprites.front_default
